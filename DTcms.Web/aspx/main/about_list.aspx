...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/20161114013920275.png\" alt=\"\"></div>\r\n    <div class=\"wrap1\">\r\n        <div class=\"w1200 clearfix\">\r\n            <div class=\"left1\">\r\n                <div class=\"navtitle\">公司概况</div>\r\n                <ul class=\"nav\">\r\n                    ");
	DataTable newsList = get_category_child_list("about",0);
	...
	templateBuilder.Append(linkurl("about_list",Utils.ObjectToStr(ncdr["id"])));
	...
	templateBuilder.Append("\r\n                </ul>\r\n            </div>\r\n            <div class=\"productr\">\r\n                ");
	string category_nav = get_category_menu("about_list", category_id);
	...
	DataTable newsList1 = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "about_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <li><a href=\"");
	templateBuilder.Append(linkurl("about_show",Utils.ObjectToStr(dr["category_id"]),Utils.ObjectToStr(dr["id"])));
