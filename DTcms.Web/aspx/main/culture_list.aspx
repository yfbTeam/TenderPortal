...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable newsList = get_category_child_list("culture",0);
	...
	templateBuilder.Append(linkurl("culture_list",Utils.ObjectToStr(ncdr["id"])));
	...
	templateBuilder.Append("\r\n                </ul>\r\n            </div>\r\n            <div class=\"productr\">\r\n                ");
	string category_nav = get_category_menu("culture_list", category_id);
	...
	DataTable newsList1 = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "culture_list", category_id, "__id__");
