...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                </ul>\r\n            </div>\r\n            <div class=\"productr\">\r\n                ");
	string category_nav = get_category_menu("mes_list", category_id);
	...
	DataTable newsList1 = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "mes_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <li><a href=\"");
	templateBuilder.Append(linkurl("mes_show",Utils.ObjectToStr(dr["category_id"]),Utils.ObjectToStr(dr["id"])));
