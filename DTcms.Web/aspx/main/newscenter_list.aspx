...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	const string channel = "newscenter";
	...
	DataTable newsList = get_category_child_list("newscenter",0);
	...
	templateBuilder.Append(linkurl("newscenter_list",Utils.ObjectToStr(ncdr["id"])));
	...
	templateBuilder.Append("\r\n                </ul>\r\n            </div>\r\n            <div class=\"productr\">\r\n                ");
	string category_nav = get_category_menu("newscenter_list", category_id);
	...
	DataTable newsList1 = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "newscenter_list", category_id, "__id__");
