...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable newsList = get_category_child_list("server",0);
	...
	templateBuilder.Append(linkurl("server_list",Utils.ObjectToStr(ncdr["id"])));
	...
	templateBuilder.Append("\r\n                </ul>\r\n            </div>\r\n            <div class=\"productr\">\r\n                ");
	string category_nav = get_category_menu("server_list", category_id);
	...
	DataTable newsList1 = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "server_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <li><a href=\"");
	templateBuilder.Append(linkurl("server_show",Utils.ObjectToStr(dr["category_id"]),Utils.ObjectToStr(dr["id"])));
